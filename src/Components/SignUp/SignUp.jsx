...
//             <button  onClick={() => createUserWithEmailAndPassword(email, password,message,users)} type="submit" className="bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-md py-2 px-4 w-full">
//               Sign Up
//             </button>
//             <button type="button"  className="bg-red-500 hover:bg-red-600 text-white font-semibold rounded-md py-2 px-4 w-full">
//               Reset
//             </button>
//           </div>
//         </form>
...
const SignUp = () => {
  ...
  return (
    <div className="bg-gray-100 flex justify-center items-center mt-14 md:h-screen md:mt-5">
      <div className="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
        <h1 className="text-2xl font-semibold mb-4">Sign Up</h1>
        <form>
