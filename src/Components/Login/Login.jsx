...
<div class=" min-h-screen flex flex-col items-center justify-center bg-gray-300">
  <div class="  mt-20 border-2 flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
    ...
    <div class="mt-10">
      <form action="#">
        ...
        <div class="flex w-full gap-5">
          ...
          <button type="submit" class="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-red-600 hover:bg-red-700 rounded py-2 w-full transition duration-150 ease-in">
            <span class="mr-2 uppercase">RSET</span>
